...
/*   main_test.c                                        :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: bdatchar <bdatchar@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2015/05/02 19:04:22 by bdatchar          #+#    #+#             */
/*   Updated: 2015/05/03 01:17:12 by bdatchar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			ft_test_tolower(char const *str)
{
	int		iterator;
	char	*tmp;
	char	*cmp;
